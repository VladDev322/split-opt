    ...
    <div class="starter-template">
        ...
        <div class="row">
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/images/cat.jpg" alt="iPhone X 64GB">
                    <div class="caption">
                        <h3>iPhone X 64GB</h3>
                        <p>71990 руб.</p>
                        <p>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/images/cat.jpg" alt="iPhone X 256GB">
                    <div class="caption">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/images/cat.jpg" alt="HTC One S">
                    <div class="caption">
                        <h3>HTC One S</h3>
                        <p>12490 руб.</p>
                        <p>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/images/cat.jpg" alt="iPhone 5SE">
                    <div class="caption">
                        <h3>iPhone 5SE</h3>
                        <p>17221 руб.</p>
                        <p>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/images/cat.jpg" alt="Наушники Beats Audio">
                    <div class="caption">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/images/cat.jpg" alt="Камера GoPro">
                    <div class="caption">
                        <h3>Камера GoPro</h3>
                        <p>12000 руб.</p>
                        <p>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/images/cat.jpg" alt="Камера Panasonic HC-V770">
                    <div class="caption">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/images/cat.jpg" alt="Кофемашина DeLongi">
                    <div class="caption">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/images/cat.jpg" alt="Холодильник Haier">
                    <div class="caption">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/images/cat.jpg" alt="Блендер Moulinex">
                    <div class="caption">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/images/cat.jpg" alt="Мясорубка Bosch">
                    <div class="caption">
